...
const loginLimiter = rateLimit({
  ...
  message:
    "Demasiados intentos de inicio de sesión desde esta IP, por favor intente nuevamente después de 15 minutos.",
});
...
app.use(require("./router/adopciones.router"));
app.use(require("./router/mascotas.router"));
app.use(require("./router/vacunas.router"));
app.use(require("./router/historialMedico.router"));
app.use(require("./router/tipo.router"));
app.use(require("./router/enfermedades.router"));
